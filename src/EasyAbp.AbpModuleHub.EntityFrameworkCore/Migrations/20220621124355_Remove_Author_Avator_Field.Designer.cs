...
namespace EasyAbp.AbpModuleHub.Migrations
{
    ...
    [Migration("20220621124355_Remove_Author_Avator_Field")]
    partial class Remove_Author_Avator_Field
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyAbp.AbpModuleHub.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EasyAbp.AbpModuleHub.Authors.AuthorStoreMapping", b =>
                {
                    ...
                    b.HasKey("StoreId", "AuthorId");

                    b.HasIndex("StoreId", "AuthorId");

                    b.ToTable("AppUserStoreMappings", (string)null);
                });

            modelBuilder.Entity("EasyAbp.AbpModuleHub.HubModules.HubModule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("HubModuleTypeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HubModuleTypeId");

                    b.ToTable("AppHubModules", (string)null);
                });

            modelBuilder.Entity("EasyAbp.AbpModuleHub.HubModules.HubModuleType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppHubModuleTypes", (string)null);
                });
            ...
            modelBuilder.Entity("EasyAbp.AbpModuleHub.HubModules.HubModule", b =>
                {
                    b.HasOne("EasyAbp.AbpModuleHub.Authors.Author", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EasyAbp.AbpModuleHub.HubModules.HubModuleType", "HubModuleType")
                        .WithMany()
                        .HasForeignKey("HubModuleTypeId");

                    b.Navigation("Author");

                    b.Navigation("HubModuleType");
                });
